      ...
      <div className="flex flex-col gap-y-5">
        ...
        <div className="flex flex-col items-center justify-between gap-2 sm:flex-row">
          <DownloadButton 
            ...
            filePath="/files/[v1.3] Template Proposal Skripsi_Ilmu Komputer_UNNES.docx"
            fileName="[v1.3] Template Proposal Skripsi_Ilmu Komputer_UNNES.docx"
          />
          <DownloadButton 
            icon={<TbFileTypePdf size={24} />}
            targetText="Download PDF"
            filePath="/files/[v1.3] Template Proposal Skripsi_Ilmu Komputer_UNNES.pdf"
            fileName="[v1.3] Template Proposal Skripsi_Ilmu Komputer_UNNES.pdf"
          />
          <DownloadButton 
